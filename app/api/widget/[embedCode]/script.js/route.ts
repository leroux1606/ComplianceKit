...
(function() {
  ...
  // Safe if site has no Google products — gtag/dataLayer calls are no-ops.
  ...
  // Synchronous: set consent state + fire gtag update immediately for returning visitors.
  ...
  // Persistent button that lets visitors re-open their preferences at any time.
  ...
  // Settings modal — opened by withdrawal button or by "Customize" inside the banner.
  // Reuses .ck-* CSS classes already injected by injectStyles().

...
<div style="background:#fefce8;border:1px solid #ca8a04;border-radius:6px;padding:16px 20px;margin-bottom:24px;font-family:sans-serif;font-size:14px;line-height:1.5;color:#713f12;">
  <strong style="display:block;margin-bottom:6px;">&#9888;&#65039; Template Notice — Not Legal Advice</strong>
  This policy was generated by ComplianceKit based on information you provided. It is a starting template only and has not been reviewed by a qualified legal professional. You should have this document reviewed by a lawyer before publishing it on your website. ComplianceKit accepts no liability for the accuracy or completeness of this template.
</div>
<h1>Cookie Policy</h1>
